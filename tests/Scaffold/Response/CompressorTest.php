 ...
 */
class Scaffold_Response_CompressorTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->object = new Scaffold_Response_Compressor;
    }

    public function testNoCompression()
    {
    	$encoder = new Scaffold_Response_Compressor(false);
    ...
    {
    	$encoder = new Scaffold_Response_Compressor(1);
    ...
    {
    	$encoder = new Scaffold_Response_Compressor(0);
    	$this->assertEquals($encoder->get_encoding_method(),false);
    	$this->assertEquals($encoder->get_compression_level(),false);
    }
    ...
    {
    	$encoder = new Scaffold_Response_Compressor(true);
    }
